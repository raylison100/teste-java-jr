...
O teste consiste em montar uma aplicação Java capaz de recuperar informações de um arquivo JSON, persistir um cadastro em um banco de dados em memória ou em arquivo e listar os cadastros em uma interface simples.

## Proposta 

Seu desafio é elaborar um sistema em Java capaz de:

1. Permitir o cadastro de jogadores de acordo com os codinomes contidos nos link de referência vingadores.json
...
4. Obter, a qualquer momento, a lista de todos os jogadores cadastrados com seus respectivos codinomes
5. Impedir a utilização de um mesmo codinome para diferentes usuários
6. Obrigatoriamente, ler a informação do codinome em arquivos na internet (link abaixo). Atenção: não vale guardar a informação do codinome localmente (em um arquivo, em uma classe, em um banco de dados etc.)
...
+ Lista escolhida não tem codinomes disponíveis:
	1. O usuário 'João' cadastra seu nome, e-mail e telefone, e escolhe a lista vingadores.json
	2. O sistema recebe o cadastro e verifica se há codinomes disponíveis na lista vingadores.json
...
+ Relatório de usuários cadastrados:
	1. O usuário 'Luís' seleciona em “Visualizar relatório de jogadores”
...
5. Criar uma interface em cmd que contenha um formulário para receber nome, e-mail e telefone
6. Criar uma interface em cmd que liste os jogadores cadastrados por nome, e-mail, telefone, codinome e lista de referência
...
13. Aguarde o entramos em contato.
